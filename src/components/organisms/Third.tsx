          ...
          <Stack spacing={1}>
            <Stack spacing={1} sx={{ justifyContent: 'center', alignItems: 'center' }}>
              ...
              <p>
                ...
                때문이에요. 또한 완성도 높은 결과물을 위해 TypeScript 도 함께 사용했어요. 그리고 휴대폰 앱으로도 사용할
                수 있게 PWA를 적용 시켰고, pc화면에서의 대응도 가능 하도록 반응형으로 제작했어요.
              </p>
              <p>
            ...
            <Stack spacing={1} sx={{ justifyContent: 'center', alignItems: 'center' }}>
              ...
              <p>
                ...
                사용하여 객체형태로 데이터를 만들었어요. 첫 사이드 프로젝트였어서 많이 부족했지만, 앞으로 더 많은 것을
